...
class PlayerInfo implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_in_maze'] = isset($data['is_in_maze']) ? $data['is_in_maze'] : null;
     ...
     * @return bool
     */
    public function getIsInMaze()
    {
        return $this->container['is_in_maze'];
    }

    /**
     * Sets is_in_maze
     *
     * @param bool $is_in_maze An indication of whether a player is currently playing a maze or not.
     *
     * @return $this
     */
    public function setIsInMaze($is_in_maze)
    {
        $this->container['is_in_maze'] = $is_in_maze;
